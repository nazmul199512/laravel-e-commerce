                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +8801798128799</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> nazmul199512@gamil.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">E-Shop<i class="fa fa-angle-down"></i></a>
                    ...
                    <div class="panel-group category-products" id="accordian">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{URL::to('/product-by-category/'.$v_category->category_id)}}">
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{URL::to('/product-by-manufacture/'.$manufacture->manufacture_id)}}">
                                        <span class="pull-right">(50)</span>{{$manufacture->manufacture_name}}</a></li>
                                    <?php }?>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">E-shopper</a></span></p>
            </div>
        </div>
    </div>
